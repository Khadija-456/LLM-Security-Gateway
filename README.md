...
│
├── policy_engine/            # Decision-making & policy enforcement
│   └── (allow/block logic)
│
...
5️⃣ Install additional packages for PII detection
...
📊 Running Evaluations
1️⃣ Prepare test input files

Place your test prompts in evaluation/. Example files:
